...
export default {
  ...
  assets: {
    ...
    'projetos/index.html': {size: 196655, hash: 'e7680a145f699f6ba68f2cf6554804184071e4b4af3cc7895efa77e5539c7f61', text: () => import('./assets-chunks/projetos_index_html.mjs').then(m => m.default)},
