...
.about-card[_ngcontent-ng-c3479495215] {
  padding: 1.25rem;
  border: 1px solid rgba(148, 163, 184, 0.16);
  background: rgba(8, 15, 28, 0.86);
}
.about-header[_ngcontent-ng-c3479495215]   h2[_ngcontent-ng-c3479495215] {
  margin: 0.4rem 0 0;
  font-size: clamp(1.8rem, 3vw, 2.4rem);
  font-family: "Space Grotesk", sans-serif;
}
.eyebrow[_ngcontent-ng-c3479495215] {
  margin: 0;
  text-transform: uppercase;
  letter-spacing: 0.18em;
  font-size: 0.72rem;
...
.about-card[_ngcontent-ng-c3479495215]   mat-card-content[_ngcontent-ng-c3479495215] {
  padding-top: 1rem;
}
.about-card[_ngcontent-ng-c3479495215]   p[_ngcontent-ng-c3479495215] {
  margin: 0 0 1rem;
  line-height: 1.8;
  color: #cbd5e1;
}
.skills-grid[_ngcontent-ng-c3479495215] {
  display: grid;
  grid-template-columns: repeat(2, minmax(0, 1fr));
  gap: 1rem;
  margin-top: 1.5rem;
}
.skills-grid[_ngcontent-ng-c3479495215]   article[_ngcontent-ng-c3479495215] {
  padding: 1rem;
  border-radius: 20px;
  border: 1px solid rgba(148, 163, 184, 0.16);
  background: rgba(15, 23, 42, 0.45);
}
.skills-grid[_ngcontent-ng-c3479495215]   mat-icon[_ngcontent-ng-c3479495215] {
  color: #7dd3fc;
}
.skills-grid[_ngcontent-ng-c3479495215]   h3[_ngcontent-ng-c3479495215] {
  margin: 0.7rem 0 0.35rem;
  font-size: 1rem;
}
.skills-grid[_ngcontent-ng-c3479495215]   p[_ngcontent-ng-c3479495215] {
  margin: 0;
}
